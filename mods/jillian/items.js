...
exports.BattleItems = {
	...
	"buzzwoliumz": {
		...
		zMoveFrom: "Focus Punch",
		zMoveUser: ["Buzzwole"],
		gen: 7,
		desc: "If holder is a Buzzwole with Focus Punch, it can use One Punch Knock Out.",
	},
	"celesteeliniumz": {
		id: "celesteeliniumz",
		...
		spritenum: 647,
		onTakeItem: false,
		zMove: "Steel Shielding Tower",
		zMoveFrom: "Heavy Slam",
		zMoveUser: ["Celesteela"],
		gen: 7,
		desc: "If holder is a Celesteela with Heavy Slam, it can use Steel Shielding Tower.",
	},
	"guzzlordiumz": {
		id: "guzzlordiumz",
		name: "Guzzlordium Z",
