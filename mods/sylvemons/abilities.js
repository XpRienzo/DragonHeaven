	...
	"schooling": {
		...
		onStart: function (pokemon) {
			...
			if (pokemon.hp > pokemon.maxhp / 4) {
				...
				if (pokemon.template.speciesid === 'wishiwashischool'&& pokemon.item.name !== 'Graduation Scale') {
					pokemon.formeChange('Wishiwashi');
					this.add('-formechange', pokemon, 'Wishiwashi', '[from] ability: Schooling');
				}
			}
		//	if (sourceItem === 'Graduation Scale') {
			//	this.pokemon.ability === 'Intimidate';
		//	}
		},
	"knightsblade": {
